...
plt.title('Base model metrics')
plt.ylabel('metrics')
plt.xlabel('epoch')
plt.legend(['mean_squared_error', 'mean_absolute_error', 'mean_absolute_percentage_error', 'root_mean_squared_error'], loc='upper right')
plt.axis([0, 20, 0, 25])
plt.show()
model.save("my_base_model_layers")
